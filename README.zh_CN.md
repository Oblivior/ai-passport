...
尚缺 Bits 结算及基于认证特征的路线、独立 Flux 适配、增量采集优化、可选物种、相遇、音效和正式精灵素材。真机断电、电池续航和连续三天人工体验属于独立验收，主机模拟不能代替。无线常驻后与 Wi-Fi 扫描、96 KB 录音等硬件演示并发的完整资源验收未完成；日常使用 AI Pet / Pet Link 页面。
