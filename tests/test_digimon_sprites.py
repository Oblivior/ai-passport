...
assert generated.count(".cf = LV_COLOR_FORMAT_RGB565A8") == 69
assert len([name for name, _ in arrays if name.startswith("dark_")]) == 6
print("Digimon sprites: PASS (source hash, 21 standard + 2 branch forms, 3 poses, alpha and bounds)")
